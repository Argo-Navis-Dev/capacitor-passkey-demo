...
export interface Client {
   ...
   */
  add_signer: ({signer}: {signer: Signer}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
   ...
   */
  remove_signer: ({signer_key}: {signer_key: SignerKey}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
   ...
   */
  update_signer: ({signer}: {signer: Signer}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
   ...
   */
  update_contract_code: ({hash}: {hash: Buffer}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAAAAAAAAAAAKYWRkX3NpZ25lcgAAAAAAAQAAAAAAAAAGc2lnbmVyAAAAAAfQAAAABlNpZ25lcgAAAAAAAA==",
